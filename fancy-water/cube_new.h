...
class cube_new : public bardrix::shape {//Creating a test cube based on the sphere header
    protected:
    ...
    public:
        cube_new();
        explicit cube_new(double radius);
        cube_new(double radius, const bardrix::point3& position);

        cube_new(double radius, const bardrix::point3& position, const bardrix::material& material);
